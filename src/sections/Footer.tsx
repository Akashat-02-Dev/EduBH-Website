    ...
    <footer className="bg-black text-[#BCBCBC] text-sm py-16 text-center">
      <div className="container">
        <div className="inline-flex relative before:content-[''] before:top-2 before:bottom-0 before:blur before:w-full before:bg-[linear-gradient(to_right,#F87BFF,#FB92CF,#FFDD9B,#C2F0B1,#2FD8FE)] before:absolute">
          <Image src={mainLogo} height={40} alt="EduBh logo" className="relative" />
        </div>
        ...
        <div className="flex justify-center items-center gap-6 mt-8">
          ...
          <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer"><SocialInsta className="w-5 h-5 hover:opacity-80 transition-opacity cursor-pointer" /></a>
          <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer"><SocialLinkedIn className="w-5 h-5 hover:opacity-80 transition-opacity cursor-pointer" /></a>
          <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer"><Image src={facebookPng} alt="Facebook" width={20} height={20} className="hover:opacity-80 transition-opacity cursor-pointer" /></a>
        </div>
